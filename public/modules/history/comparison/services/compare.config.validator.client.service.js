'use strict';
define([], function () {
    return ['CompareConfigValidator', ['comparisonConstants',function (comparisonConstants) {
                        ...
                        if(Array.isArray(currAttrNode)) {
                            for(var loopIndex = 0; loopIndex < currAttrNode.length; loopIndex++) {
                                ...
                                if("type" in currElement) {
                                    ...
                                    var supportedDataTypesArray = comparisonConstants.COMP_ENGINE_CONST.IN_BUILT_DATA_TYPES;
                                ...
                                if("compEngine" in currElement) {
                                    var supportedCompEngineArray = comparisonConstants.COMP_ENGINE_CONST.COMP_ENGINE;
        ...
        return isSampleCompConfigValid;
