...
CKEDITOR.plugins.add( 'basicstyles', {
	...
	init: function( editor ) {
		...
		var addButtonCommand = function( buttonName, buttonLabel, commandName, styleDefiniton, iconClass ) {
...
//BALOO - Revised by keshav Garg
		...
		//BALOO - Revised by keshav Garg
		//font class is added to bold and italic
		addButtonCommand( 'Bold', lang.bold, 'bold', config.coreStyles_bold , 'baloo-font baloo-icon-bold');
		addButtonCommand( 'Italic', lang.italic, 'italic', config.coreStyles_italic, 'baloo-font baloo-icon-italic');
