...
CKEDITOR.plugins.add( 'removeformat', {
	...
	init: function( editor ) {
		...
		editor.ui.addButton && editor.ui.addButton( 'RemoveFormat', {
			...
			toolbar: 'cleanup,10',
			iconClass: 'baloo-font baloo-icon-remove-format'
		} );
	}
} );
...
//BALOO - Revised by Keshav Garg
	//removed 'class' attribute from the list;
CKEDITOR.config.removeFormatAttributes = 'style,lang,width,height,align,hspace,valign';
