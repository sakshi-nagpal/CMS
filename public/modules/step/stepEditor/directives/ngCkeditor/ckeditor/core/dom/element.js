...
( function() {
	CKEDITOR.tools.extend( CKEDITOR.dom.element.prototype, {
		...
		scrollIntoParent: function( parent, alignToTop, hscroll ) {
            ...
            //BALOO - Revised by MOHIT KANSAL - Added 20px extra scroll to take the element in view
			if ( lt.y < 0 || br.y > 0 ) {
                scrollBy( 0, alignToTop === true ? lt.y - 20 : alignToTop === false ? br.y + 20 : lt.y < 0 ? lt.y - 20 : br.y + 20 );
            }
