...
define(['documentModule', 'angularMocks'], function () {
    ...
    describe('viewBoxDirective', function () {
        var $compile, $rootScope, $httpBackend, stateParams;
        ...
        beforeEach(inject(function (_$compile_, _$httpBackend_, _$rootScope_) {
            ...
            $rootScope.scenario = sampleScenario;
        }));

        it('get the missing test documents', function () {
            var element = $compile("<section scenario-Document-View></section>>")($rootScope);
            $rootScope.$digest();
            $httpBackend.flush();
            expect(element.find('.file-list-item').length).toBe(9);
        });
